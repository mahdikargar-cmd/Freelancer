...
const DetailSuggest: React.FC<DetailSuggestProps> = ({projectId, proposal}) => {
    const {id} = useParams();
    ...
    if (error) {
        return (
            <div
                className="bg-red-50  dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl p-6  text-center shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto mb-4 text-red-500" fill="none"
        ...
        return (
            <div className="bg-light-color5 dark:bg-color5 rounded-2xl p-8 text-center shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg"
                     className="h-16 w-16 mx-auto mb-4 text-light-color7 dark:text-color7" fill="none"
                     viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        ...
        return (
            <div className="bg-white dark:bg-color5 rounded-xl shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-primaryMedium text-light-color2 dark:text-color2">اطلاعات اصلی
                        پیشنهاد</h2>
                    {getStatusBadge(fetchedProposal.status)}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <div className="mb-4">
                            ...
                            <p className="text-light-color2 dark:text-color2 font-primaryMedium">{fetchedProposal.title}</p>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-light-color2 dark:text-color2 font-primaryMedium flex items-center">
                                <span
                                    className="bg-light-color5 dark:bg-color6 rounded-lg px-3 py-1 text-light-color4 dark:text-color4">
                                    {new Intl.NumberFormat('fa-IR').format(fetchedProposal.proposedBudget)} تومان
                                </span>
                            </p>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-light-color2 dark:text-color2">{fetchedProposal.estimatedDuration} روز</p>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <div>
                                {fetchedProposal.assigned ? (
                                    <span
                                        className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 px-3 py-1 rounded-full text-sm">
                                        اختصاص داده شده
                                    </span>
                                ) : (
                                    <span
                    ...
                    <div>
                        ...
                        <div className="bg-light-color5 dark:bg-color6 rounded-lg p-4 h-64 overflow-y-auto">
                            <p className="text-light-color2 dark:text-color2 whitespace-pre-wrap">{fetchedProposal.content}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    const renderProjectInfo = () => {
        return (
            <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                    <span
                                        className="bg-light-color5 dark:bg-color6 rounded-lg px-3 py-1 text-light-color2 dark:text-color2">
                ...
                <div className="bg-white dark:bg-color5 rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-primaryMedium text-light-color2 dark:text-color2 mb-4">دسته‌بندی
                        پروژه</h2>
                    <div className="flex items-center space-x-2 rtl:space-x-reverse">
                        {fetchedProposal.projectId.category?.parentCategory?.name && (
                            <>
                                <span
                                    className="bg-light-color5 dark:bg-color6 rounded-lg px-3 py-1 text-light-color3 dark:text-color3">
                                    {fetchedProposal.projectId.category.parentCategory.name}
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="h-5 w-5 text-light-color7 dark:text-color7" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                          d="M9 5l7 7-7 7"/>
                                </svg>
        ...
        <div className="bg-light-color1 dark:bg-color1 rounded-2xl shadow-lg overflow-hidden">
            <div className="p-6 bg-light-color5 dark:bg-color5 border-b border-light-color6 dark:border-color6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-primaryMedium text-light-color2 dark:text-color2">
                        جزئیات پیشنهاد
                    </h1>
                    <div className="flex items-center space-x-2 rtl:space-x-reverse">
                        <span className="text-sm text-light-color7 dark:text-color7">شناسه پیشنهاد:</span>
                        <span
                            className="bg-light-color5 dark:bg-color6 text-light-color2 dark:text-color2 px-3 py-1 rounded-lg text-sm">
                            {fetchedProposal.id}
                        </span>
                    </div>
                </div>
