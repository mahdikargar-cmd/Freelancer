            ...
            <div className="max-w-screen-md mx-auto py-8 px-4 md:px-8">
                ...
                <div className="mb-8">
                    <div className="flex justify-between mb-2 text-xs font-primaryMedium">
                        <span className="text-light-color2 dark:text-color2">مرحله {step} از 6</span>
                ...
                >
                    ...
                    {step === 1 && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                        >
                            <h1 className="font-primaryDemibold text-xl text-light-color1 dark:text-white mb-3">1 از 6</h1>
                    ...
                    {step === 2 && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                        >
                            <h1 className="font-primaryDemibold text-xl text-light-color1 dark:text-white mb-3">2 از 6</h1>
                            <h2 className="text-lg font-primaryMedium mb-4 flex items-center gap-2">
                    ...
                    {step === 3 && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                        >
                            <h1 className="font-primaryDemibold text-xl text-light-color1 dark:text-white mb-3">3 از 6</h1>
                            <h2 className="text-lg font-primaryMedium mb-4 flex items-center gap-2">
                            ...
                            {technologies.length > 0 && (
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {technologies.map((tech, index) => (
                                        <div key={index} className="bg-blue-500 text-light-color1 dark:text-color1 px-3 py-2 rounded-lg font-primaryBold shadow-md flex items-center gap-2">
                                            {tech}
                                            <button
                    ...
                    {step === 4 && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                        >
                            <h1 className="font-primaryDemibold text-xl text-light-color1 dark:text-white mb-3">4 از 6</h1>
                            <h2 className="text-lg font-primaryMedium mb-4 flex items-center gap-2">
                    ...
                    {step === 5 && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                        >
                            <h1 className="font-primaryDemibold text-xl text-light-color1 dark:text-white mb-3">5 از 6</h1>
                            <h2 className="text-lg font-primaryMedium mb-4 flex items-center gap-2">
                                <FaDollarSign className="text-light-color4 dark:text-color4 text-xl" /> نوع ارز پرداختی رو مشخص کن
                            </h2>
                            <div className="grid grid-cols-3 gap-3">
                                {["ریالی", "دلار", "ارز دیجیتال"].map((curr) => (
                                    <button
                                        ...
                                        className={`p-3 rounded-lg border font-primaryMedium ${currency === curr
                                            ? "bg-light-color8 dark:bg-color8 border-light-color5 dark:border-color5 text-light-color1 dark:text-color1"
                                            : "bg-light-color6 dark:bg-color6 border-light-color5 dark:border-color5 text-light-color3 dark:text-color3 hover:bg-light-color5/20 dark:hover:bg-color5/20"
                    ...
                    {step < 6 && (
                        <div className="mt-8 flex flex-col md:flex-row gap-3">
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 px-6 bg-light-color8 dark:bg-color8 hover:bg-light-color9 dark:hover:bg-color9 text-light-color1 dark:text-color1 rounded-lg font-primaryBold transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 ${((step === 1 && !projectName) || (step === 2 && !description) || (step === 3 && technologies.length === 0))
                    ...
                    {step === 6 && (
                        <div className="mt-6">
                            ...
                            >
                                ثبت نهایی پروژه <FaCheckCircle className="text-light-color5 dark:text-color5 text-xl" />
                            </button>
                        </div>
                    )}
                </motion.div>
