...
const Header = async () => {
    ...
    return (
        <nav className="w-full z-20 top-0 start-0 mt-6 bg-color6">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:justify-around mx-2 md:mx-auto p-4 bg-color1 rounded-full border border-color5">
