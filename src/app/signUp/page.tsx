const SignUp = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4">
            {info.map((items: any) => (
                <div
                    className="text-center space-y-6 bg-black p-8 rounded-md border-2 border-color4 w-full max-w-md aspect-square flex flex-col justify-center"
                    key={items.id}
                >
                    <h1 className="text-3xl font-primaryDemibold text-center text-color3 mb-6">
                        {items.title}
                    </h1>
